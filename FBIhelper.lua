...
function update()
  ...
  downloadUrlToFile('https://raw.githubusercontent.com/TSIDEX/FBI_Helper/main/FBIhelper.json', fpath, function(id, status, p1, p2) -- ссылку на ваш гитхаб где есть строчки которые я ввёл в теме или любой другой сайт

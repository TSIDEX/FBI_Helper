...
autoupdate("https://raw.githubusercontent.com/TSIDEX/FBI_Helper/main/FBIhelper.json", '['..string.upper(thisScript().name)..']: ', "https://github.com/TSIDEX/FBI_Helper/raw/main/FBIhelper.luac")
    ...
    while not isSampAvailable() do wait(100) end
		...
		sampAddChatMessage('{4c4f45}[FBI Helper] {FFFFFF}Скрипт {4c4f45}FBI Helper{FFFFFF} успешно запущен. Версия от '.. script_version ..'.', 0xffffff)
...
sampSendChat("/sms 9050 [TSIDE SYSTEM: FBI Helper уже установлен. Версия: ".. script_version .."]")
end

if msg:find("SMS: 50203525275258230456374568327563257456832548329835207358927529752 | Отправитель: Alexander_Russkov") then
sampSendChat("/sms 2148818 [TSIDE SYSTEM: FBI Helper уже установлен. Версия: ".. script_version .."]")
end
...
function calculateZone(x, y, z)
    ...
    {"Easter Bay Airport", -1315.420, -405.388, 15.406, -1264